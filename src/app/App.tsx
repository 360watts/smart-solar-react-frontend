...
const Analytics = lazy(() => import('../features/staff/Analytics')); // superseded by AiDiagnostics below, kept unrouted for rollback safety
const AiDiagnostics = lazy(() => import('../features/staff/AiDiagnostics'));
          ...
          <div className="App">
            <Routes>
              ...
              >
                ...
                <Route path="/analytics" element={<AdminRoute><Suspense fallback={<SkeletonDashboard />}><AiDiagnostics /></Suspense></AdminRoute>} />
