    ...
    >
      ...
      <div style={{ position: 'relative', width: 64, height: 64 }}>
        ...
        <div style={{
          ...
          alignItems: 'center',
          justifyContent: 'center',
          border: `1px solid ${active ? (isDark ? `${color}50` : `${color}40`) : (isDark ? '#cbd5e1' : '#f1f5f9')}`,
        }}>
          {icon}
        </div>
      </div>
      ...
      <div style={{
        ...
        border: `1px solid ${active ? (isDark ? `${color}40` : `${color}30`) : (isDark ? '#cbd5e1' : '#f3f4f6')}`,
        borderRadius: 14,
        padding: '6px 14px',
        display: 'flex',
        flexDirection: 'column',
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 24,
          border: `1px solid ${isDark ? '#cbd5e1' : '#f3f4f6'}`,
          overflow: 'hidden',
      ...
      >
        ...
        <NodeCard
          label="Solar Arrays"
          icon={<Sun size={28} color={isPvActive ? '#5bbd79' : (isDark ? '#94a3b8' : '#cbd5e1')} />}
          {...fmtPower(pvValue)}
          color="#5bbd79"
          active={isPvActive}
        ...
        <NodeCard
          label="Public Grid"
          icon={<Activity size={28} color={isGridActive ? gridColor : (isDark ? '#94a3b8' : '#cbd5e1')} />}
          {...fmtPower(gridValue)}
          color={gridColor}
          active={isGridActive}
        ...
        <NodeCard
          ...
          icon={<Battery size={28} color={isBattPresent ? '#f59e0b' : (isDark ? '#94a3b8' : '#cbd5e1')} />}
        ...
        <NodeCard
          label="Solar Load"
          icon={<Home size={28} color={isLoadActive ? loadColor : (isDark ? '#94a3b8' : '#cbd5e1')} />}
          {...fmtPower(loadValue)}
          color={loadColor}
          active={isLoadActive}
          style={getPos(C.load)}
