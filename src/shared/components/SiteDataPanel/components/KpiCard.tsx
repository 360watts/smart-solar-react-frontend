  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
        <span style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--muted-foreground)', fontFamily: 'Poppins, sans-serif' }}>
          {label}
        </span>
        <motion.div
      ...
      >
        {value}
        {unit && <span style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--muted-foreground)', marginLeft: 4 }}>{unit}</span>}
      </motion.p>
      {sub && (
        <motion.p
          ...
          style={{ margin: '6px 0 0', fontSize: '0.75rem', fontWeight: 600, color: 'var(--muted-foreground)', fontFamily: 'Poppins, sans-serif' }}
        >
          {sub}
        </motion.p>
      )}
